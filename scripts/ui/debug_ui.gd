...
@onready var build_cost_label = $MarginContainer/VBoxContainer/BuildCost
...
func update_labels() -> void:
	...
	build_cost_label.text = "Selected Building Cost: " + str(BuildManager.current_building_cost)
